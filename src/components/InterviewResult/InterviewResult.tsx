...
const InterviewResult = () => {
  ...
  return (
    <section className='interview-result sections'>
      ...
      <p className='interview-result__subtitle page__text'>
        Вы ответили <span className='page__span'></span> правильно на "<span className='page__span'>{rightAnswersCount ? rightAnswersCount : 0}</span>" вопросов из "<span className='page__span'>{interview?.questions.length}</span>"
      </p>
